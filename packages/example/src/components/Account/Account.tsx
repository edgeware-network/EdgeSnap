      ...
      <CardContent>
        <Grid container alignItems="center">
          <Grid item md={6} xs={12}>
            ...
            <Typography variant="h6">Account Balance: {formatBalance(props.balance, { decimals: 18, withSi: true, withUnit: getCurrency(props.network) })}</Typography>
            {/* eslint-disable-next-line max-len */}
            <Typography variant="subtitle2">{formatBalance(props.balance, { decimals: 18, withSi: true, withUnit: getCurrency(props.network) })}</Typography>
          </Grid>
        </Grid>
